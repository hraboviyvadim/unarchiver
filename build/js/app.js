...
document.addEventListener('DOMContentLoaded', function () {
  // slider
  var swiper = new _swiper2.default('.js-slider', {
    nextButton: '.js-next',
    prevButton: '.js-prev'
  });
  // expanede block
  (function () {
    var block = document.querySelectorAll('.js-show');
    [].slice.call(block).forEach(function (item) {
      var btn = item.querySelector('.js-show-more');
